...
export class HangmanService {
    ...
    getHangManGameState(id: number) : Promise<HangmanGameState> {
    ...
    makeGuess(hangmanGameState: HangmanGameState, guess: string) : Promise<HangmanGameState> {

        return this.getHangManGameState(hangmanGameState.id).then(hangmanGameState => {
            ...
            const url = this.hangmanGameStateUrl + '/' + hangmanGameState.id;
